...
export const HeroSection = () => {
  ...
  return (
    <section
      ...
      <div className="absolute inset-0 overflow-hidden bg-gradient-to-b from-background via-background/50 to-background">
        {[...Array(20)].map((_, i) => (
          <motion.div
            key={i}
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-6">
              ...
              <span
                className={`text-sm font-medium text-primary ${isRTL ? "font-arabic" : ""}`}>
                {t("hero.badge")}
              </span>
            </div>
