...
const testimonials = [
  {
    ...
    content: 'Elegant Options transformed our customer service completely. The AI agent handles 80% of inquiries automatically, saving us countless hours.',
    contentAr: 'حولت إليجانت أوبشنز خدمة العملاء لدينا بالكامل. يتعامل وكيل الذكاء الاصطناعي مع 80٪ من الاستفسارات تلقائياً، مما يوفر لنا ساعات لا تحصى.',
    rating: 5,
  ...
  },
  {
    ...
    content: 'The WhatsApp Business API integration was seamless. Our campaign open rates jumped to 98% and conversions increased by 40%.',
    contentAr: 'كان تكامل واتساب للأعمال سلساً للغاية. قفزت معدلات فتح حملاتنا إلى 98٪ وزادت التحويلات بنسبة 40٪.',
    rating: 5,
  ...
  },
  {
    ...
    content: 'The review booster system helped us get 200+ new Google reviews in just 3 months. Our online reputation has never been better.',
    contentAr: 'ساعدنا نظام تعزيز المراجعات في الحصول على أكثر من 200 مراجعة جديدة على جوجل في 3 أشهر فقط. سمعتنا الإلكترونية لم تكن أفضل من ذلك.',
    rating: 5,
  ...
  },
  {
    ...
    content: 'Implementing the full automation suite reduced our operational costs by 60%. The ROI was visible within the first month.',
    contentAr: 'أدى تنفيذ مجموعة الأتمتة الكاملة إلى تقليل تكاليفنا التشغيلية بنسبة 60٪. كان العائد على الاستثمار واضحاً خلال الشهر الأول.',
    rating: 5,
